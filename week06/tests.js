...
describe('Week 6 Lab Tests:', () => {
  ...
  describe("Question 1c: Day of the week", () => {
    ...
    it("#Should return Monday with input of 1", () => {
      expect(dayOfTheWeek(1)).to.equal("Monday")
    })

    it("#Should return Sunday with input of 7", () => {
      expect(dayOfTheWeek(7)).to.equal("Sunday")
    })

    it("#Should return undefined with input of 0", () => {
      expect(dayOfTheWeek(0)).to.equal(undefined)
    })
